...
public class MultilayerPerceptronELU extends NeuralNetwork<BackPropagation> {
    ...
    /**
     * Creates new MultilayerPerceptronELU with specified number of neurons in layers
     *
     * @param neuronsInLayers collection of neuron number in layers
     */
    public MultilayerPerceptronELU(double alpha, List<Integer> neuronsInLayers) {
        // init neuron settings
        NeuronProperties neuronProperties = new NeuronProperties();
        neuronProperties.setProperty("useBias", true);
        neuronProperties.setProperty("transferFunction", ExponentialLinearUnit.class);
        neuronProperties.setProperty("transferFunctionAlpha", alpha);

        this.createNetwork(neuronsInLayers, neuronProperties);
    }

    public MultilayerPerceptronELU(double alpha, int... neuronsInLayers) {
        // init neuron settings
        NeuronProperties neuronProperties = new NeuronProperties();
        neuronProperties.setProperty("useBias", true);
        neuronProperties.setProperty("transferFunction", ExponentialLinearUnit.class);
    ...
    /**
     * Creates new MultilayerPerceptronELU net with specified number neurons in
     * getLayersIterator
     *
    ...
    /**
     * Creates MultilayerPerceptronELU Network architecture - fully connected
